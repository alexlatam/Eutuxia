...
<div class="container">
  <div class="row" style="margin-top:5rem; margin-bottom: 5rem;">
	  <div class="col-sm-6">
	    ...
	    <a href="" type="button" class="btn btn-primary btn-rounded text-white">Mas Información</a>
	  </div>
  ...
  <script>
	...
	<div class="row mb-5">
	    ...
	    <div class="col-sm-6">
	      ...
	      <button type="button" class="btn btn-primary btn-rounded">Empezar una conversación</button>
	    </div>
	  </div>
</div>
          ...
          <div class="col-md-10">
            <div class="row separator-bottom pb-5 mb-5">
              ...
              <div class="col-md-8">
                ...
                <p class="text-center">
                  <a class="btn btn-primary btn-rounded px-5"  href="">¡Conversemos unos minutos!  </a>
                </p>
              </div>
            </div>
            {{-- <div class="row mt-4">
