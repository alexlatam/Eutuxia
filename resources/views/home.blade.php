        ...
        <div class="container">
          <div class="row align-items-end vh-75">
            <div class="col-md-5 text-white">
              ...
              <a href="https://web.whatsapp.com/send?phone=584143446225&text=Hola,%20%20quiero%20mas%20informaci%C3%B3n%20de%20sus%20servicios.%20" class="btn btn-with-ico btn-primary">Iniciar el crecimiento<i class="icon-arrow-right2 fs-20"></i></a>
            </div>
          </div>
        </div>
      </div>
...
<div class="container">
  <div class="row" style="margin-top:5rem; margin-bottom: 5rem;">
	  <div class="col-sm-6">
	    ...
	    <a href="https://web.whatsapp.com/send?phone=584143446225&text=Hola,%20%20quiero%20mas%20informaci%C3%B3n%20de%20sus%20servicios.%20" type="button" class="btn btn-primary btn-rounded text-white">Mas Información</a>
	  </div>
	...
	<div class="row mt-4">
	  ...
	  <div class="col-sm-6">
	    ...
	    <a  href="https://web.whatsapp.com/send?phone=584143446225&text=Hola,%20%20quiero%20mas%20informaci%C3%B3n%20de%20sus%20servicios.%20" type="button" class="btn btn-primary btn-rounded" >¡Quiero mi página!</a>
	  </div>
  </div>
  ...
  <script>
	...
	<div class="row" style="margin-top:5rem; margin-bottom: 5rem;">
	  <div class="col-sm-6">
	    ...
	    <a  href="https://web.whatsapp.com/send?phone=584143446225&text=Hola,%20quiero%20una%20Tienda%20Online." type="button" class="btn btn-primary btn-rounded">Crear mi tienda!</a>
	  </div>
	  <div class="col-6 d-none d-sm-block" style="text-align:left;">
      <div class="cont_image">
        <img src="imagen/tablet_page.png" alt="" width="100%">
	...
	<div class="row mb-5">
	    ...
	    <div class="col-sm-6">
	      ...
	      <a  href="https://web.whatsapp.com/send?phone=584143446225&text=Hola,%20%20quiero%20mas%20informaci%C3%B3n%20de%20sus%20servicios.%20" type="button" class="btn btn-primary btn-rounded">Empezar una conversación</a>
	    </div>
	  </div>
</div>
      ...
      <div class="container px-5">
        <div class="row justify-content-between align-items-center text-center text-md-left">
          ...
          <div class="col-md-4 text-lg-right">
            <a href="https://web.whatsapp.com/send?phone=584143446225&text=Hola,%20%20quiero%20mas%20informaci%C3%B3n%20de%20sus%20servicios.%20" class="btn btn-primary btn-rounded px-5">
          ...
          <div class="col-md-10">
            <div class="row separator-bottom pb-5 mb-5">
              ...
              <div class="col-md-8">
                ...
                <p class="text-center">
                  <a class="btn btn-primary btn-rounded px-5"  href="https://web.whatsapp.com/send?phone=584143446225&text=Hola,%20Quiero%20conversar%20de%20mi%20proyecto.%20">¡Conversemos unos minutos!  </a>
                </p>
              </div>
            </div>
            {{-- <div class="row mt-4">
    ...
    <div class="row">
      ...
      <div class="col">
        ...
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1934px;"><div class="owl-item active" style="width: 366.667px; margin-right: 20px;"><div class="step">
            ...
            <p>Escribenos por nuestros medios de <a href="https://web.whatsapp.com/send?phone=584143446225&text=Hola,%20Quiero%20conversar%20de%20mi%20proyecto.%20"><b class="text-primary">CONTACTO.</b></a></p>
            ...
            <p>Preparate porque empieza la <a href="https://web.whatsapp.com/send?phone=584143446225&text=Hola,%20Quiero%20conversar%20de%20mi%20proyecto.%20"><b class="text-primary">AVENTURA</b></a></p>
